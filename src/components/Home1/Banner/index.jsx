          ...
          <div className="row g-xl-4 gy-5">
            <div className="col-xxl-8 col-xl-7 d-flex align-items-center wow fadeInUp" data-wow-delay="200ms">
              <div className="banner-content">
                ...
                <h1>Ihr Traumwagen <span>erwartet Sie.</span></h1>
                <p>Finden Sie Ihren Traumwagen bei uns – ein Fahrerlebnis, das Wunsch und Wirklichkeit vereint. Unsere Experten führen Sie mit exzellenter Beratung direkt zu Ihrem perfekten Modell.</p>
                <div className="customar-review">
                  <ul>
                    <li>
                      <a href="https://www.google.com/search?q=carcenter+erding&oq=carcenter+er&gs_lcrp=EgZjaHJvbWUqDwgAECMYJxjjAhiABBiKBTIPCAAQIxgnGOMCGIAEGIoFMhIIARAuGCcYrwEYxwEYgAQYigUyBggCEEUYOzIGCAMQRRhAMgYIBBBFGDkyBggFEEUYPDIGCAYQRRg8MgYIBxBFGDyoAgCwAgA&sourceid=chrome&ie=UTF-8">

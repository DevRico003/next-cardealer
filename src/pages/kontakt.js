  ...
  return (
    <MainLayout>
        <div className="contact-page pt-100 mb-100">
            ...
            <div className="row g-12 justify-content-center mb-100">
                <div className="col-lg-12">
                <div className="single-location">
                    <div className="title-and-view-btn">
                    <h5>CarCenterErding</h5>
                    <a href="https://www.google.de/maps/place/CarCenter+Erding+e.K./@48.2867204,11.8944177,17z/data=!3m1!4b1!4m6!3m5!1s0x479e104125907d51:0xa3afd5561caf5a25!8m2!3d48.2867204!4d11.8969926!16s%2Fg%2F1hm627x55?entry=ttu">in Maps anzeigen
                    ...
                    <li>
                        ...
                        <div className="info">
                        <a href="tel:+4981222280164">+49 8122 2280164</a>
                        <a href="tel:+49174 4720904">+49 174 4720904</a>
                        </div>
                    </li>
                    <li>
                        <div className="icon">
                        ...
                        <div className="info">
                        <a>Otto-Hahn-Str. 4, 85435 Erding</a>
                        </div>
                    </li>
                    </ul>
                </div>
            ...
            <div className="row g-4 mb-100">
                ...
                <div className="service-available">
                    ...
                    <p><strong>Mo - Fr: 09:00 - 18:00 | Sa: 10:00 - 17:00 | So: Ruhetag</strong></p>
                </div>
                </div>
        ...
        <div className="contact-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2654.8386260231764!2d11.894417677176728!3d48.28672037126042!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479e104125907d51%3A0xa3afd5561caf5a25!2sCarCenter%20Erding%20e.K.!5e0!3m2!1sde!2sde!4v1704027854017!5m2!1sde!2sde" style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
        </div>
    </MainLayout>
  )
}

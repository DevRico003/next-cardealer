                ...
                <div className="single-item mb-50" id="ueberblick">
                  <div className="overview">
                    ...
                    <div className="overview-content">
                      <ul>
                        <li><span>Marke & Modell</span> {car['carModel']}</li>
                        <li><span>Erstzulassung</span> {car.firstRegistration && car.firstRegistration.split('-').reverse().join('/')}</li>
                        <li><span>Kilometer</span> {car.mileage && car.mileage.match(/\d+/g) ? parseInt(car.mileage.match(/\d+/g)[0]).toLocaleString('de-DE') + ' km' : ''}</li>
                        <li><span>Türen</span> {car['door-count']}</li>
                        <li><span>Kraftstoff</span> {car['fuelTypes']}</li>
                        <li><span>Getriebe</span> {car['gearbox']}</li>
                        <li><span>Leistung</span> {car['power']}</li>
                        <li><span>Innenbereich-Farbe</span> {car['interior-color']}</li>
                      </ul>
                      <ul>
                        <li><span>Emmissionsklasse</span> {car['emission-class']}</li>
                        <li><span>Euro-Plakette</span> {car['emission-sticker']}</li>
                        <li><span>Klimaanlage</span> {car['climatisation']}</li>
                        <li><span>Airbag</span> {car['airbag']}</li>
                        <li><span>HU</span> {car['HU_AU_NEU']}</li>
                        <li><span>Sitzplätze</span> {car['numSeats']}</li>
                        <li><span>Außenbereich-Farbe</span> {car['exterior-color']}</li> 
                        <li><span>Innenbereich-Material</span> {car['interior-type']}</li>
                      </ul>
                    </div>
                  </div>
                </div>

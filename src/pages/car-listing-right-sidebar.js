...
function CarListingRightSidebar() {
                    ...
                    <div className="row g-4 justify-content-center mb-40">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        <div className="product-card">
                          ...
                          <div className="product-content">
                            <h5><Link legacyBehavior href="/car-deatils"><a>Cadillac Escalade-2023</a></Link></h5>
                            <div className="price-location">
                              <div className="price">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                        <div className="product-card">
                          ...
                          <div className="product-content">
                            <h5><Link legacyBehavior href="/car-deatils"><a>Subaru Outback-2023</a></Link></h5>
                            <div className="price-location">
                              <div className="price">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        <div className="product-card">
                          ...
                          <div className="product-content">
                            <h5><Link legacyBehavior href="/car-deatils"><a>Kia Telluride-2023</a></Link></h5>
                            <div className="price-location">
                              <div className="price">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        <div className="product-card">
                          ...
                          <div className="product-content">
                            <h5><Link legacyBehavior href="/car-deatils"><a>Volkswagen Golf-2023</a></Link></h5>
                            <div className="price-location">
                              <div className="price">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="300ms">
                        <div className="product-card">
                          ...
                          <div className="product-content">
                            <h5><Link legacyBehavior href="/car-deatils"><a>Lexus RX-2021</a></Link></h5>
                            <div className="price-location">
                              <div className="price">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-12 wow fadeInUp item" data-wow-delay="200ms">
                        <div className="product-card">
                          ...
                          <div className="product-content">
                            <h5><Link legacyBehavior href="/car-deatils"><a>Nissan Altima-2022</a></Link></h5>
                            <div className="price-location">
                              <div className="price">
                                <strong>$7,656.00</strong>
                              </div>
...
export default CarListingRightSidebar